  ...
  return (
    <>
      <Container className="flex flex-col">
        ...
        <section
          id="hero"
          className="min-h-[50vh] sm:min-h-[70vh] flex flex-col md:pt-10"
        >
          <div className="w-fit flex flex-1 duration-500 fly-up opacity-0 -translate-2 max-w-4xl mx-auto flex-col justify-center items-center md:items-start">
            <h1 className="text-2xl sm:text-4xl text-pink-500 text-center w-full font-[900] py-3">
              {APP_NAME}
            </h1>
            <h1 className="text-3xl sm:text-[3.125rem] sm:leading-[4rem] font-[700] text-sky-800 text-center pb-10">
              We&apos;re results oriented Software Engineering Team,{" "}
              <span>Ready to address your tech challanges</span>
            </h1>
            <Link
              href={"/contact-us"}
              className="w-fit mx-auto group p-3 cursor-pointer flex gap-5 items-center shadow-xl drop-shadow-xl rounded-[4rem] hover:bg-sky-400 transition-all duration-300"
            >
      ...
      <Container className="w-full flex mb-10 flex-col gap-5 min-h-[80vh]">
        ...
        <div className="w-full min-w-full grid gap-x-5 gap-y-10 md:grid-cols-2 xl:grid-cols-3">
          {services.map((service, index) => (
            <div
              key={index}
              className={`w-full flex flex-col gap-2 p-5 rounded-xl hover:shadow-xl border border-${service.color}-500 hover:bg-${service.color}-500 transition-all hover:text-sky-100`}
            >
        ...
        <div className="py-5 bg-secondary p-5 rounded-sm">
          <h1 className="text-sky-900 text-2xl font-600">
            Already trusted by:
          </h1>
          <div className="flex gap-5 py-2 flex-wrap justify-center">
            {partners.map((partner, index) => (
              <div
                className="w-fit flex gap-2 items-center px-5 sm:px-10 text-sm sm:text-base py-1 sm:py-3 border rounded-[2rem] text-pink-500 border-pink-500"
                key={index}
              >
                <Image
                  src={partner.logo}
      ...
      <Container className="w-full flex flex-col md:flex-row-reverse mb-10 rounded-sm overflow-hidden">
        <div className="relative w-full md:w-1/2 bg-slate-800 flex flex-col justify-center items-center">
          <div className="w-full max-w-[500px] p-5">
            <h1 className="text-4xl sm:text-5xl text-primary-foreground font-[700]">
              {"We're "} here to help.
            </h1>
            <p className="text-muted py-5">
              Just imagine and let&apos;s build it into a real solution that can
              impact a postive change onto your business, clients or your
              comunity at large.
            </p>
            <Link href="/contact-us" className="w-fit flex">
              <Button className="bg-slate-700 hover:bg-slate-200 min-w-60 text-slate-200 hover:text-slate-600 font-bold">
                Talk to the Expert
              </Button>
            </Link>
          </div>
        ...
        <div className="w-full flex flex-col md:flex-row px-5 py-20 border rounded-sm">
          <div className="p-5 w-full md:w-1/2 flex flex-col gap-5 border-b md:border-b-0 md:border-r">
            ...
            <p className="text-sm md:text-base sm:px-5 line-clamp-5">
              “A wonderful team that I would always want to work with due to
              their commitment to the success of the projects they work on.”
            </p>
            <div className="flex gap-5 w-full py-5 md:px-5 items-center">
              ...
              <div className="flex h-fit flex-col gap-1">
                ...
                <p className="text-sm md:text-sm text-muted-foreground font-bold">
                  CEO of Blusonet
                </p>
              </div>
            </div>
          ...
          <div className="p-5 w-full md:w-1/2 flex flex-col gap-5">
            ...
            <p className="text-sm md:text-base sm:px-5 line-clamp-5">
              “What a hardworking team of Engineers, I am really greatfull with
              the work they did on my website.”
            </p>
            <div className="flex gap-5 w-full py-5 md:px-5 items-center">
              <div className="w-fit p-0 m-0">
                <div className="h-10 md:h-20 w-10 md:w-20 max-w-20 max-h-20 rounded-full bg-muted"></div>
      ...
      <section className="w-full bg-sky-950 overflow-hidden min-h-96 p-5 mb-20">
        <Container>
          <h2 className="text-center text-sky-200 font-[700] -mb-8 pt-10">
            Grow faster
          </h2>
          ...
          <div className="grid grid-cols-3 gap-5 w-full">
            ...
            <div className="col-span-3 md:col-span-1 bg-sky-900 rounded-sm p-5 flex flex-col justify-between">
              <h2 className="text-sky-100 grid-row-2 font-[700] py-5 text-xl">
                We design for{" "}
                <span className="text-sky-200">Responsiveness</span>
              </h2>
              <Image
                src="/responsive.jpg"
                alt="performance"
                height={1000}
                width={1000}
                className="w-full rounded-sm max-w-96 mx-auto h-auto"
              />
              <p className="text-sky-100 py-5 leading-5">
                Get a high performant App or suppercharge your App with the
                performance and user exprience you need.
              </p>
            </div>
            <div className="col-span-3 md:col-span-1 bg-sky-900 rounded-sm p-5 flex flex-col justify-between">
              <h2 className="text-sky-100 grid-row-2 font-[700] py-5 text-xl">
                We buid for <span className="text-sky-200">Performance</span>
              </h2>
              <Image
                src="/hpc.jpg"
                alt="performance"
            ...
            <div className="col-span-3 md:col-span-1 bg-sky-900 rounded-sm p-5 flex flex-col justify-between">
              <h2 className="text-sky-100 font-[700] py-5 text-xl">
                And we ensure <span className="text-sky-200">Security</span>
              </h2>
              <Image
                src="/security.jpg"
                alt="performance"
                height={1000}
                width={1000}
                className="w-full max-w-96 rounded-sm mx-auto h-auto"
              />
              <p className="text-sky-100 py-5 leading-5">
                Get a secure App or upgrade your App to enhance security for
                both your data and your clients.
              </p>
            </div>
          </div>
        </Container>
